...
1. <a href="https://raw.githubusercontent.com/marcelbest/essential-seo/main/source/assets/screenshot-1.png">View screenshot</a> — The plugin is accessible under Settings → Essential SEO in the WordPress admin menu.
2. <a href="https://raw.githubusercontent.com/marcelbest/essential-seo/main/source/assets/screenshot-2.png">View screenshot</a> — The settings page lets you configure the title separator, default description, share image and tracking scripts.
3. <a href="https://raw.githubusercontent.com/marcelbest/essential-seo/main/source/assets/screenshot-3.png">View screenshot</a> — The SEO meta box can be enabled per editor via Preferences → Document settings → SEO.
4. <a href="https://raw.githubusercontent.com/marcelbest/essential-seo/main/source/assets/screenshot-4.png">View screenshot</a> — The SEO meta box on a page — enter a custom meta description or leave empty to fall back to the excerpt or site default.
5. <a href="https://raw.githubusercontent.com/marcelbest/essential-seo/main/source/assets/screenshot-5.png">View screenshot</a> — The SEO meta box works the same way on posts.
6. <a href="https://raw.githubusercontent.com/marcelbest/essential-seo/main/source/assets/screenshot-6.png">View screenshot</a> — The plugin outputs clean meta tags in the HTML head — description, Open Graph tags and more.
